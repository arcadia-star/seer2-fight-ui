...
public class UI_PetTypeIcon_N {
    ...
    public static function find(idx:int):Class {
        ...
        if (idx == 1) {
            return UI_PetTypeIcon_1;
        }
        if (idx == 2) {
            return UI_PetTypeIcon_2;
        }
        if (idx == 3) {
            return UI_PetTypeIcon_3;
        }
        if (idx == 4) {
            return UI_PetTypeIcon_4;
        }
        if (idx == 5) {
            return UI_PetTypeIcon_5;
        }
        if (idx == 6) {
            return UI_PetTypeIcon_6;
        }
        if (idx == 7) {
            return UI_PetTypeIcon_7;
        }
        if (idx == 8) {
            return UI_PetTypeIcon_8;
        }
        if (idx == 9) {
            return UI_PetTypeIcon_9;
        }
        if (idx == 10) {
            return UI_PetTypeIcon_10;
        }
        if (idx == 11) {
            return UI_PetTypeIcon_11;
        }
        if (idx == 12) {
            return UI_PetTypeIcon_12;
        }
        if (idx == 13) {
            return UI_PetTypeIcon_13;
        }
        if (idx == 14) {
            return UI_PetTypeIcon_14;
        }
        if (idx == 15) {
            return UI_PetTypeIcon_15;
        }
        if (idx == 16) {
            return UI_PetTypeIcon_16;
        }
        if (idx == 17) {
            return UI_PetTypeIcon_17;
        }
        if (idx == 18) {
            return UI_PetTypeIcon_18;
        }
        if (idx == 19) {
