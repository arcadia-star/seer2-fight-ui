...
public class HpDecreaseAnimation extends Sprite {
    ...
    [Embed(source="/assets/UI_Arena.swf", symbol="UI_FightSplash")]
    static var UI_FightSplash:Class;
    [Embed(source="/assets/UI_Arena.swf", symbol="UI_FightHurtTip")]
    static var UI_FightHurtTip:Class;
    [Embed(source="/assets/UI_Arena.swf", symbol="UI_FightSplashMinus")]
    static var UI_FightSplashMinus:Class;
    ...
    private function createHurtTip():void {
        var _loc1_:MovieClip = new UI_FightHurtTip;
        var _loc2_:int = 1;
        if (this._isBaoJi) {
            _loc2_ = 4;
    ...
    private function createDigitSpriteVec(param1:uint = 1):void {
        ...
        var _loc2_:MovieClip = new UI_FightSplashMinus;
        ...
        var _loc5_:int = 0;
        while (_loc5_ < _loc4_) {
            (_loc6_ = new (UI_FightSplash_N.find(_loc3_[_loc5_]))).gotoAndStop(param1);
